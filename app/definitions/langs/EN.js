exports.Labels = {
    ...
    "AllowSSH" : "SSH",
    "AllowSSH_Description" : "Enables access to Remote Management console accessible from browser.",
    "NginxDirectives" : "NGINX directives",
    "NginxDirectives_Description" : "Here you can specify the settings for the nginx reverse proxy server that runs in front of Apache. Use the same syntax as you use for nginx.conf. For example, if you want to pack all the proxied requests with gzip, add the line: 'gzip_proxied any;'.",
    "MaxUsers" : "Max users",
    ...
    "JXcoreAppArgs_Description" : "Command-line arguments for the application. They will be also visible in `process.argv` property.",
    "JXcoreAppArgsCannotParse" : "Cannot parse application parameters.",
    ...
    "JXcoreNotInstalled" : "JXcore is not installed.",
    ...
    "JXcoreAppPortsPerDomain" : "Ports per domain",
