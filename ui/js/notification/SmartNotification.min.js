...
$.SmartMessageBox = function(a, b) {
    ...
    for (var i = 0; i <= a.buttons.length - 1; i++){
        if("[" == a.buttons[i])
            ...
            k += 1;
            window.activeBot = "bot" + parseInt(k) + "-Msg" + SmartMSGboxCount;
    ...
    d += "</div>", d += "</div>", d += "</div>", SmartMSGboxCount > 1 && ($(".MessageBoxContainer").hide(), $(".MessageBoxContainer").css("z-index", 99999)), $(".divMessageBox").append(d), 1 == h && $("#txt" + SmartMSGboxCount).focus(),
